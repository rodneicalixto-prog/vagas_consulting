        ...
        <div className="mb-6 rounded-2xl border border-border bg-surface p-5">
          ...
          {!candidatosContratados || candidatosContratados.length === 0 ? (
            ...
            <form action={criarPrestacao} className="flex flex-wrap items-end gap-2.5">
              ...
              <button type="submit" className="rounded-lg bg-gold px-4 py-2.5 text-[12px] font-extrabold text-[#1c1508]">
                + Registrar
              </button>
            </form>
          )}
              ...
              return (
                <div key={e.id} className="rounded-2xl border border-border bg-surface p-4">
                  ...
                  <p className="mt-1 text-[11.5px] text-text-2">
                    ...
                    {e.valor ? ` · R$ ${e.valor} ${e.periodicidade ?? ""}` : ""}
                  </p>
                  ...
                  <form action={atualizarPagamento} className="mt-3 flex flex-wrap items-end gap-2.5">
                    ...
                    <button type="submit" className="rounded-lg bg-navy px-4 py-2 text-[11.5px] font-extrabold text-white">
                      Salvar
                    </button>
                  </form>
                </div>
